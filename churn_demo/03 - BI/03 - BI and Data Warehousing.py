...
# MAGIC %md-sandbox
# MAGIC
# MAGIC ## Running and visualizing your first Queries
# MAGIC
...
# MAGIC FROM main.odl_user_XXX.churn_orders
# MAGIC WHERE
...
# MAGIC 	(
# MAGIC 		SELECT user_id FROM main.odl_user_XXX.churn_prediction WHERE churn_prediction=1
# MAGIC 	)
# MAGIC ```
# MAGIC Create a *counter* visualisation
# MAGIC
...
# MAGIC FROM main.odl_user_XXX.churn_prediction GROUP BY churn_prediction;
# MAGIC ```
# MAGIC
...
# MAGIC FROM main.odl_user_XXX.churn_features
...
# MAGIC from main.odl_user_XXX.churn_app_events
# MAGIC inner join cmain.odl_user_XXX.hurn_users using (user_id)
...
# MAGIC FROM main.odl_user_XXX.churn_prediction
